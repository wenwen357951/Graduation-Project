 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "import sys\n",
       ...
       "ROOT_DIR = os.docs.abspath(\"../../\")\n",
       "\n",
       "# Import Mask RCNN\n",
       "sys.docs.append(ROOT_DIR)  # To find local version of the library\n",
       ...
       "MODEL_DIR = os.docs.join(ROOT_DIR, \"logs\")\n",
       "\n",
       "# Local docs to trained weights file\n",
       "COCO_MODEL_PATH = os.docs.join(ROOT_DIR, \"mask_rcnn_coco.h5\")\n",
       "# Download COCO trained weights from Releases if needed\n",
       "if not os.docs.exists(COCO_MODEL_PATH):\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        # Add classes\n",
       ...
       "            self.add_image(\"shapes\", image_id=i, docs=None,\n",
  ...
  },
  {
   ...
   "source": [
       ...
       "# model_path = os.docs.join(MODEL_DIR, \"mask_rcnn_shapes.h5\")\n",
  ...
  },
  {
   ...
   "source": [
    "class InferenceConfig(ShapesConfig):\n",
       ...
       "                          model_dir=MODEL_DIR)\n",
       "\n",
       "# Get docs to saved weights\n",
       "# Either set a specific docs or find last trained weights\n",
       "# model_path = os.docs.join(ROOT_DIR, \".h5 file name here\")\n",
