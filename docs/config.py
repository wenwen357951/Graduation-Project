...
ASSETS_DATAAUGMENTATIONIMAGE_CT_TURN_LEFT_5DEGREE_DIR = os.path.join(ASSETS_DATAAUGMENTATIONIMAGE_DIR,  "CtTurnLeft5Degree (1000 x 570)")
ASSETS_DATAAUGMENTATIONIMAGE_CT_RIGHT_LEFT_5DEGREE_DIR = os.path.join(ASSETS_DATAAUGMENTATIONIMAGE_DIR, "CtTurnRight5Degree (1000 x 570)")
ASSETS_DATAAUGMENTATIONIMAGE_MIRROR_CT_TURN_LEFT_5DEGREE_DIR = os.path.join(ASSETS_DATAAUGMENTATIONIMAGE_DIR, "MirrorCtTurnLeft5Degree (1000 x 570)")
ASSETS_DATAAUGMENTATIONIMAGE_MIRROR_CT_TURN_RIGHT_5DEGREE_DIR = os.path.join(ASSETS_DATAAUGMENTATIONIMAGE_DIR, "MirrorCtTurnRight5Degree (1000 x 570)")
